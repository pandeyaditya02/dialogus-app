...
const productionsData = [
  {
    ...
    duration: "12:35",
    synopsis:
      "A deep dive into the historical and cultural factors that continue to challenge Hindu-Muslim unity in India.",
  },
  {
    id: "Hy_9H97bPgE",
    title:
    ...
    duration: "08:42",
    synopsis:
      "Experts discuss the ethical and strategic implications of warfare in modern geopolitics.",
  },
  {
    id: "HzrQc3sgtSs",
    title:
      "India has a huge development agenda; war is not the country's priority",
    duration: "15:20",
    synopsis:
      "Qamar Agha explains why India is focusing on economic development over military conflict.",
  },
  {
    id: "Ryp224aa05Y",
    title:
      "India needs to expand its fighter squadrons to bolster national security",
    duration: "11:10",
    synopsis:
      "An analysis of India’s current air force capabilities and future needs for national security.",
  },
  {
    id: "4PTGVVsbrAU",
    ...
    duration: "09:55",
    synopsis:
      "Investigating the origins and motives behind the recent attack in Pahalgam.",
  },
  {
    id: "ATg1cBN8hR0",
    ...
    duration: "14:05",
    synopsis:
      "Exploring the role India can play in reviving the World Trade Organization for global benefit.",
  },
  {
    id: "j7F5KNw5F20",
    ...
    duration: "18:30",
    synopsis:
      "An explosive look into allegations of casteism within one of India's largest airlines.",
  },
  {
    id: "Qz8E3T4L0zY",
    ...
    duration: "22:15",
    synopsis:
      "How AI is revolutionizing diagnostics, treatment, and patient care across the globe.",
  },
];
  ...
  <div className="video-card-container group relative rounded-lg overflow-hidden cursor-pointer">
    ...
    >
      ...
      <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-between p-4">
        <div>
          <span className="bg-black/50 text-white text-xs font-bold py-1 px-2 rounded absolute top-2 right-2">
            {duration}
          </span>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <p className="text-gray-400 mt-4">
              Explore our full library of in-depth analysis and compelling
              stories.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
            {productionsData.map((video) => (
