// app/shorts/ShortsPaginationControls.tsx
    ...
    <div className="flex flex-col sm:flex-row justify-between items-center mt-16 gap-4">
      ...
      <div className="hidden md:flex items-center gap-2">
        {totalPages > 5 && currentPage > 3 && (
          <>
            <Link href="/shorts?page=1" className="px-4 py-2 text-gray-500 hover:text-gray-900 transition-colors">1</Link>
        ...
        {totalPages > 5 && currentPage < totalPages - 2 && (
          <>
            <span className="text-gray-400">...</span>
            <Link href={`/shorts?page=${totalPages}`} className="px-4 py-2 text-gray-500 hover:text-gray-900 transition-colors">{totalPages}</Link>
          </>
        )}
      </div>
