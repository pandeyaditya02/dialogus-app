...
const DisclaimerCard = ({ icon, title, text }: { icon: React.ReactNode, title: string, text: string }) => (
    <div className="card-base p-6 text-center items-center flex flex-col">
        <div className="w-12 h-12 flex items-center justify-center rounded-lg bg-fuchsia-500/10 text-fuchsia-600">
            {icon}
        </div>
        <h3 className="text-lg font-bold text-gray-900 mt-4">{title}</h3>
        <p className="text-gray-600 text-sm mt-2 flex-grow">{text}</p>
    </div>
);
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-5xl mx-auto">
                        <div className="text-center">
                            ...
                            <p className="text-gray-600 max-w-2xl mx-auto">The following terms apply to all content on our website, YouTube channel, and other digital platforms. By accessing our content, you agree to this notice.</p>
                        </div>
                        ...
                        {/* <div className="mt-16 text-center border-t border-gray-200 pt-10">
                            ...
                            <p className="text-gray-600">If you have any questions about this Disclaimer Notice, please contact us at:</p>
                            <p className="mt-4 text-gray-800">[Official email address]</p>
